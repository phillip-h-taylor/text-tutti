...
public class HelpService {
    ...
    public List<String> getHelpMessages() {
        ...
        String partsMessage = "Multiple parts may be entered by ending a part with ampersands before starting the next one. Each part can have its own instrument and volume.";
        String exampleMessage = "A simple example of a message would be \"I56,T45,TITitle,FIfile,C58,G58,C616,E6,ET15END\". Good luck!";
